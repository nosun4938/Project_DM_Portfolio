...
public class MonsterState_Knockdown : MonsterState_HitResponse
{
    public MonsterState_Knockdown(Monster owner, MonsterStateMachine stateMachine) : base(owner, stateMachine) { }
    public override void Enter()
    {
        ...
        switch (Owner.CreatureWeapon)
        {
            ...
            default:
                Owner.Animator.Play("No_Knockdown", 0, 0f);
                Managers.Sound.Play(ESound.Effect, "Stagger", volume: 0.3f);
                break;
        }
    }
