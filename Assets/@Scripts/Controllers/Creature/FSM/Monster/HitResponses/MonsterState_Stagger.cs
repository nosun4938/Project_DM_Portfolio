...
public class MonsterState_Stagger : MonsterState_HitResponse
{
    public MonsterState_Stagger(Monster owner, MonsterStateMachine stateMachine) : base(owner, stateMachine) { }
    float decel;
    public override void Enter()
    {
        ...
        switch (Owner.CreatureWeapon)
        {
            ...
            default:
                Owner.Animator.Play("No_Stagger", 0, 0f);
                Managers.Sound.Play(ESound.Effect, "Stagger", volume: 0.3f);
                break;
        }
    }
