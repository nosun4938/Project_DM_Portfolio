...
public class MonsterState_LastHit : MonsterState_HitResponse
{
    public MonsterState_LastHit(Monster owner, MonsterStateMachine stateMachine) : base(owner, stateMachine) { }
    float decel;
