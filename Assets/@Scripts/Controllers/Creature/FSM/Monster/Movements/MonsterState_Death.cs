...
public class MonsterState_Death : MonsterStateBase
{
    public MonsterState_Death(Monster owner, MonsterStateMachine stateMachine) : base(owner, stateMachine) { }
    public override void Enter()
    {
        ...
        Owner.StartCreatureCoroutine(EndSkillAfterDelay(1.5f));
    }
